 ...
 * multiple answers are possible for a list. In that case print all possible answers in non decreasing order. Input:
 * First Line of input contains an integer t representing the number of test cases, Where first line of each test case
 * has an integers N - number of integers in list, Next line contains N integers. Output: print all the possible modes
 * in non-increasing order. Constraints: 1<=t<=100 1<=N<100000 1<=a[i]<=1000000
 */
