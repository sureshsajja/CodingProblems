 ...
 * Now given a memory X, you have to tell the position of the memory in Sherlock's mind palace. Input ===== Input begins
 * with a line containing space separated N and M. The next N lines each contain M numbers, each referring to a memory
 ...
 * <p/>
 * Output ====== If Y is present in Mr. Holmes memory, output its position (0-based indexing). Else output "-1 -1"
